...
public class Example {
    public static void main(String[] args) {
        ...
        // Currently malfunctional, however to authenticate via OAuth 2.0, pass it a File object of the OAuth 2.0 authentication json file. E.g storing it as "auth.json" in C:/data
        File authFile = new File("C:/data/auth.json");

        // Obtain firebase4j connection by constructing a FirebaseConnection object, with the root URL of the firebase, e.g "https://my-project.firebaseio.com" (https is important!)
        FirebaseConnection con;
        try {
            con = new FirebaseConnection("https://my-project.firebaseio.com");
            // with authentication, this would be new FirebaseConnection("https://my-project.firebaseio.com", authFile)
        ...
        try {
            // First parameter is the File object to the json to post, second is directory
